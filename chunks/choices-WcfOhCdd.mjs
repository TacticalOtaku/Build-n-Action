...
var BlueprintEditorApp = class extends foundry.applications.api.ApplicationV2 {
	...
	async _onFirstRender() {
		...
		if (!content) return;
		try {
			const { mountEditor } = await import("./editor-B-RMqAIQ.mjs");
...
function repairMigratedBlueprint(blueprint, original) {
	...
	const [from] = incoming;
	if (condition && from && incoming.length === 1 && onlyYes && !condition.data.checks.length) {
...
//#endregion
export { documentBlueprints as $, replaceData as A, asNumber as At, createRider as B, pendingRoll as C, getResult as Ct, sourceLabel as D, CHECKS as Dt, loadTraitTrees as E, EVENTS as Et, addRider as F, CONDITION_NODE_TYPE as Ft, SETTINGS as G, canEdit as H, riderClock as I, EVENT_TYPES as It, resolveEditorTheme as J, clientSetting as K, useRiders as L, scaledFormula as M, asString as Mt, simplifyNumber as N, asStrings as Nt, registerAuraPreviews as O, CONDITION_NODE_FIELDS as Ot, resolveModifiers as P, STATIC as Pt, carrierKind as Q, countRest as R, resolveRollTarget as S, getEvent as St, effectStatus as T, RESULTS as Tt, openEditor as U, lintBlueprint as V, CLIENT_SETTINGS as W, setting as X, setClientSetting as Y, actorToken as Z, guardedAsync as _, isFieldVisible as _t, removeBlueprint as a, touchesBlueprints as at, recordUsages as b, canConnect as bt, registerMigrationMenu as c, stringList as ct, activationFor as d, createBlueprint as dt, documentFromUuid as et, activationOf as f, createCheck as ft, guarded as g, defaultsFor as gt, evaluateEvent as h, duplicateBlueprint as ht, createApi as i, rollDataOf as it, resolveForeign as j, asRecord as jt, modifyFormulaParts as k, asBoolean as kt, createFoundryHost as l, enumeratePaths as lt, announceApplied as m, createNode as mt, foundryTranslator as n, isSuppressed as nt, saveBlueprint as o, listOf as ot, allowIntents as p, createEdge as pt, registerSettings as q, createPhraseFormatter as r, originRollData as rt, validateIntegrations as s, read as st, foundryChoices as t, isDocument as tt, registerLibrary as u, MODULE_SCOPE as ut, makeRoller as v, validateBlueprintSource as vt, registerPending as w, COMMON_RESULT_FIELDS as wt, rememberActivation as x, getCheck as xt, midiActivation as y, randomId as yt, recordUsage as z };

//# sourceMappingURL=choices-WcfOhCdd.mjs.map